...
platform.suresteel.com/agent: "true"
platform.suresteel.com/team: {{ .Values.team }}
platform.suresteel.com/kind: {{ .Values.kind }}
{{- end }}

{{- define "agent.annotations" -}}
platform.suresteel.com/owner: {{ .Values.owner | quote }}
platform.suresteel.com/description: {{ .Values.description | quote }}
{{- end }}
