...
The gaps in the last column are configuration, not research. Row 13 is the one
I would close first: without a team budget, per-agent caps never sum, and
nobody signs for the total.
